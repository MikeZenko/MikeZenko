...
**Workshop AR viewer.** A WebXR prototype for the same workshop that places CAD models at 1:1 scale through Quest 3 passthrough. Uses the WebXR device API with hit-test placement and three.js, served from a small Python script on the local network. Around 650 lines of code, no build step, and nothing installed on the headset.
